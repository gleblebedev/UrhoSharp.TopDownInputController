...
public class SampleApp : Application
{
    ...
    public SampleApp(ApplicationOptions options) : base(options)
    {
    }
    ...
    private void CreateScene()
    {
        ...
        CameraNode.Position = new Vector3(3,3,3);
        CameraNode.LookAt(new Vector3(0, 0, 0), Vector3.Up, TransformSpace.World);
    }
